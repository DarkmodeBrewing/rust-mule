  ...
  files: [
    {
      ...
      source_publish_first_response_latency_ms: 40,
  ...
  uploads: [
    {
      ...
      requested_bytes_total: 131072,
      last_requested_unix_secs: 123,
      last_peer_id_hex: '-peer-send-',
      active_peer_ids: ['-peer-held-', '-peer-send-'],
      active_since_unix_secs: 120,
      last_payload_source: 'shared_file',
      zero_fill_requests_total: 1,
      zero_fill_requested_bytes_total: 65536,
      zero_fill_rate_bps_5s: 2048,
      zero_fill_rate_bps_30s: 1024,
      ...
      recent_sessions: [
        ...
        },
        {
          ...
          bytes_total: 65536,
          phase: 'sending',
          peer_id_hex: '-peer-complete-',
          payload_source: 'shared_file',
          started_unix_secs: 108,
          last_updated_unix_secs: 117,
        ...
        },
        {
          ...
          bytes_total: 65536,
          phase: 'held',
          peer_id_hex: '-peer-drop-',
          payload_source: null,
          started_unix_secs: 107,
          last_updated_unix_secs: 116,
